...
//---- PLUGIN REQUIRED -------------------------------------------------------------------------------------------
		...
		/**
		 * Tweens ColorTransform properties of a DisplayObject to do advanced display like overexposing, altering
		 ...
		 * Be aware, however, that as with most filter display, MotionBlurPlugin is somewhat CPU-intensive, so it is not
		 ...
		 * as a way to easily create interesting physics-based display with the GreenSock tweening platform. Parameters
